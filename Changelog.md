...
- Fixed some logic related to vanished player sleeping and waypoint tracking not being controllable through the "hidePlayersFromWorld" config option
