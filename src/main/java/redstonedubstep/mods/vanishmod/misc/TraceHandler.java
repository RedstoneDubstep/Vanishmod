...
public class TraceHandler {
	...
	public static void sendTraceStatus(ServerPlayer player) {
		...
		player.sendSystemMessage(Component.literal("# §bAlways enabled§r: ").append(Component.literal("§7(...)").withStyle(s -> s.withHoverEvent(new HoverEvent.ShowText(Component.literal("Hiding from the tab list and hiding your skin"))))));
